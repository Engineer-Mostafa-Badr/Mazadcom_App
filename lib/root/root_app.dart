...
import 'package:mzadcom/authentication/forgot_reset_password/cubit/reset_password_cubit.dart';
...
import 'package:mzadcom/home/widget/search/cubit/search_cubit.dart';
...
import 'package:mzadcom/authentication/registerations/company/cubit/company_register_cubit.dart';
import 'package:mzadcom/authentication/registerations/individual/cubit/individual_register_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        home: LoginScreen(),
        theme: ThemeData(
            fontFamily: 'Tajawal', scaffoldBackgroundColor: Colors.white,
