...
import 'package:mzadcom/features/pidding/bidding_screen.dart';

class BiddingBottomSheet extends StatelessWidget {
  final Color color2; // تمرير اللون كمتغير

  const BiddingBottomSheet({super.key, required this.color2});
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildAuctionAmountContainer("Auctions.started_amount".tr(),
                      "100.000", "Wallet.omr".tr(), color2),
                  SizedBox(width: 3),
                  _buildAuctionAmountContainer("Auctions.current_amount".tr(),
                      "100.000", "Wallet.omr".tr(), color2),
                ],
              ),
              SizedBox(height: 10),
  ...
  Widget _buildAuctionAmountContainer(
      String text1, String text2, String text3, Color color) {
    return Container(
