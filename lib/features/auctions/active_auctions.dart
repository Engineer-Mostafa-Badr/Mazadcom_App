...
class ActiveAuctions extends StatefulWidget {
  const ActiveAuctions({super.key});

  @override
  State<ActiveAuctions> createState() => _ActiveAuctionsState();
}

class _ActiveAuctionsState extends State<ActiveAuctions> {
  @override
