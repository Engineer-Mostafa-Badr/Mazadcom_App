...
class DirectAuctionGrid extends StatefulWidget {
  final String status;
  final List? data;

  const DirectAuctionGrid({super.key, required this.status, this.data});

  @override
  // ignore: library_private_types_in_public_api
  _DirectAuctionGridState createState() => _DirectAuctionGridState();
}

class _DirectAuctionGridState extends State<DirectAuctionGrid> {
