import 'package:mzadcom/features/auctions/RegisterForAuction/register_for_auction.dart';
...
class PreviousAuctionGrid extends StatefulWidget {
  final String status;
  final List? data;

  const PreviousAuctionGrid({super.key, required this.status, this.data});

  @override
  // ignore: library_private_types_in_public_api
  _PreviousAuctionGridState createState() => _PreviousAuctionGridState();
}

class _PreviousAuctionGridState extends State<PreviousAuctionGrid> {
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: GridView.builder(
          primary: false, // Prevents conflicting scroll
          shrinkWrap: true,
          physics:
