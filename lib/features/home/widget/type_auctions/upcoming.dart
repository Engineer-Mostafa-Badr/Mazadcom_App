...
class UpcomingAuctionGrid extends StatefulWidget {
  final String status;
  final List? data;

  const UpcomingAuctionGrid({super.key, required this.status, this.data});

  @override
  // ignore: library_private_types_in_public_api
  _UpcomingAuctionGridState createState() => _UpcomingAuctionGridState();
}

class _UpcomingAuctionGridState extends State<UpcomingAuctionGrid> {
