...
import 'package:mzadcom/authentication/registerations/widget/phone.dart';
import 'dart:io';
...
class _IndividualRegisterState extends State<IndividualRegister> {
  ...
  String mobile = "", country_code = "968";
        ...
        body: BlocConsumer<IndividualRegisterCubit, IndividualRegisterState>(
          ...
          builder: (context, state) {
            if (state is LoadingIndividualRegisterState) {
              return 
               Center(
        child: LoadingAnimationWidget.inkDrop(color:color1, size: 200
