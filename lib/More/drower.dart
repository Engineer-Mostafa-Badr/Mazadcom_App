...
class DrawerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> drawerItems = [
      ...
      {'title': 'Favourites', 'icon': Icons.favorite, 'screen': FavouritesScreen()},
      {'title': 'FAQs', 'icon': Icons.question_answer, 'screen': FAQScreen()},
      {'title': 'Terms and Conditions', 'icon': Icons.description, 'screen': TermsAndConditionsScreen()},
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () => NavigationHelper.navigateAndReplace(context, LoginPage()),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () => NavigationHelper.navigateAndReplace(context, RegistrationScreen()),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  title: Text(drawerItems[index]['title'], style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                  onTap: () {
                    if (drawerItems[index]['title'] == 'Logout') {
                      _showLogoutDialog(context);
                    } else if (drawerItems[index]['screen'] != null) {
                      NavigationHelper.navigateTo(context, drawerItems[index]['screen']);
                    } else {
