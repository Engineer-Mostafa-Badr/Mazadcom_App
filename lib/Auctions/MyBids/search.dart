...
class _SearchState extends State<Search> {
  ...
  bool isFilterVisible = false; // متغير لتتبع حالة الرؤية
  DateTime? date1; // تخزين التاريخ الأول
  DateTime? date2; // تخزين التاريخ الثاني
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        if (isFilterVisible) _buildFilterContainer(), // عرض الفلترة عند الحاجة
      ],
    );
  }
        ...
        children: [
          Container(
            ...
            child: IconButton(
              onPressed: () {
                setState(() {
                  isFilterVisible = !isFilterVisible; // تبديل الرؤية
                });
              },
              icon: const Icon(
