          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                ...
                height: screenHeight * 0.08, // ارتفاع ديناميكي
                fit: BoxFit.contain,
              ),
              SizedBox(height: screenHeight * 0.015), // ديناميكي
              Text(
                "Wallet.message".tr(),
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12),
                textAlign: TextAlign.center,
              ),
              SizedBox(height: screenHeight * 0.02), // ديناميكي

              SizedBox(
                width: screenWidth * 0.5,
                height: screenHeight * 0.06, // ديناميكي
                child: TextButton(
                  onPressed: () {
                    setState(() {
