...
import 'package:mzadcom/list_auctins/list_auctions_screen.dart';
import 'package:mzadcom/view_details/view_details_screen.dart';
import 'package:share_plus/share_plus.dart';

class AuctionGrid extends StatefulWidget {
  final String status;
  final List? data;

  const AuctionGrid({Key? key, required this.status, this.data})
      : super(key: key);

  @override
  _AuctionGridState createState() => _AuctionGridState();
}

class _AuctionGridState extends State<AuctionGrid> {
