            ...
            children: [
              ...
              Expanded(
                child: Container(
                  child: TabBarView(
                    children: [
                      AuctionLocationTab(), // محتوى تبويب الموقع
                      AuctionDocumentsTab(), // محتوى تبويب المستندات
                      AuctionInfoTab(), // محتوى تبويب معلومات المزاد
                    ],
                  ),
                ),
              ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              // هنا يمكنك وضع رابط لتحميل المستند
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: color2, // لون الزر
